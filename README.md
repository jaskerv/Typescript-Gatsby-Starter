...
<h1 align="center">
  Jono Yan Typescript Gatsby Starter
</h1>

This was built in Gatsby, default starter boiler plate.
...
1.  **Setup**
    ...
    First get your development environment setup.

    You will require:
    - Node (Preferably use [NVM](https://github.com/nvm-sh/nvm)).
    - An IDE (Preferably [VSCode](https://code.visualstudio.com/)).
...
3.  **Open the source code and start editing!**
    ...
    Open the `accell` directory in your code editor of choice and edit `src/pages/index.tsx`. Save your changes and the browser will update in real time!
...
3.  **`.eslintrc.js`**: This file is where our configuration for eslint are.

4.  **`.nvmrc`**: This file tells us what version of node is required to run this application.

5.  **`.gitignore`**: This file tells git which files it should not track / not maintain a version history for.
  
6.  **`.prettierignore`**: This file tells [Prettier](https://prettier.io/) which file to ignore.
